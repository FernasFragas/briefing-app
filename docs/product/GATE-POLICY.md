...
| Ticker | Reason |
|---|---|
| `RHM.DE` | EU coverage deferred: no free EU per-strike option chain or national OAM automation is available; see `docs/research/alternatives/pa5-eu-sources.md` and `docs/research/alternatives/pb5-fca-deferred.md`. |
| `LDO.MI` | EU coverage deferred: no free EU per-strike option chain or national OAM automation is available; see `docs/research/alternatives/pa5-eu-sources.md` and `docs/research/alternatives/pb5-fca-deferred.md`. |
| `ASML.AS` | EU coverage deferred: no free EU per-strike option chain or national OAM automation is available; see `docs/research/alternatives/pa5-eu-sources.md` and `docs/research/alternatives/pb5-fca-deferred.md`. |
| `SIE.DE` | EU coverage deferred: no free EU per-strike option chain or national OAM automation is available; see `docs/research/alternatives/pa5-eu-sources.md` and `docs/research/alternatives/pb5-fca-deferred.md`. |
