...
> normalization. See `docs/archive/still-failing.md` for the report-derived closure
...
`docs/research/SOURCE_STATUS.md` says "Alpha Vantage refuses every function." **That is no longer
