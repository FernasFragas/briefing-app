...
> `docs/research/SOURCE_STATUS.md:192`). The chain is `institutional: []` — nothing is fetched and
...
>   was nine pages and the pipeline read one. `docs/research/alternatives/pc2-retail-momentum-coverage.md`.
