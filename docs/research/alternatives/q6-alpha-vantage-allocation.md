...
in `docs/archive/provider-alternatives-wiring-tasks.md` is the policy anchor for refreshing it: build the
...
`docs/archive/still-failing.md`, then wire any adoption through the Phase B contracts.
...
- The shortlist refresh policy is Phase C in `docs/archive/provider-alternatives-wiring-tasks.md`. The
