...
├── docs/archive/implementation-tasks.md  # Task backlog and implementation plan
└── docs/archive/options-briefing-system-plan.md
```
...
- Deployment options: [DEPLOYMENT_OPTIONS.md](../operations/DEPLOYMENT_OPTIONS.md)
- Source status: [SOURCE_STATUS.md](../research/SOURCE_STATUS.md)
