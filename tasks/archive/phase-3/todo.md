...
Spec: `docs/product/SPEC-graded-ideas-report.md` · Plan: `tasks/archive/phase-3/plan.md` (both approved 2026-08-31,
...
> `docs/archive/provider-alternatives-implementation.md` separately groups `I`-tickets into **Waves 0–3**
...
`HANDOFF.md` §2, the `G1–G5` entry. Spec: `docs/product/SPEC-graded-ideas-report.md`, which is
...
- [x] **T9 — Documentation and sample artifact**
  ...
  - `docs/product/SPEC-graded-ideas-report.md`: record the thesis-band amendment as accepted, so the
  ...
  - Files: `README.md`, `docs/product/SPEC-graded-ideas-report.md`
...
- No checkpoint may require a `TRADEABLE` row to exist. There are 0 today, and there will be
  0 until the provider wiring in `docs/archive/provider-alternatives-implementation.md` lands — **I2**
