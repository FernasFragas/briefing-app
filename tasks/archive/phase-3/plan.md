...
Phase 2 of the spec-driven workflow. Spec: `docs/product/SPEC-graded-ideas-report.md` (approved
2026-08-31, defaults accepted). Plan approved 2026-08-31, including the thesis-band
amendment, and decomposed into Phase 3 in `tasks/archive/phase-3/todo.md`.

Status: **complete.** Approved, handed to Phase 3, and all nine tasks in `tasks/archive/phase-3/todo.md`
...
`docs/archive/provider-alternatives-wiring-tasks.md`, not here.
...
2. The fixture-leg disclosure is a section-level note under `data_mode: fixture`, plus a
   ...
   C5/T6.
3. `tasks/archive/phase-3/todo.md` is the active Phase 3 task list; this file remains the rationale,
