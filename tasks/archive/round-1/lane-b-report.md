...
- [ ] **B1 — Fix the ideas table ordering**
  ...
  **alphabetical string**. Because `"US:S_M,S_O"` sorts before `"US:S_M,S_O,S_S"`, which
  ...
  Both `docs/product/SPEC-graded-ideas-report.md:206` and `README.md` state that rows sort by grade
...
- [ ] **B2 — Move SPY and QQQ out of the ideas table (D6)**
  ...
  only available signal really is a hardcoded list, say so in `docs/product/REPORT-LAYOUT.md` and
  ...
  **Acceptance:**
  ...
  - The rows do not silently vanish: `docs/product/REPORT-LAYOUT.md` records where they went and
...
- [ ] **B4 — Write `docs/product/REPORT-LAYOUT.md`**
